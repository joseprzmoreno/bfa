...
from pygoogletrans.googletrans import urls, utils
from pygoogletrans.googletrans.gtoken import TokenAcquirer
from pygoogletrans.googletrans.constants import (
    DEFAULT_CLIENT_SERVICE_URLS,
    DEFAULT_FALLBACK_SERVICE_URLS,
    DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES,
    DEFAULT_RAISE_EXCEPTION, DUMMY_DATA
)
from pygoogletrans.googletrans.models import Translated, Detected, TranslatedPart
...
class Translator:
    def __init__(self, service_urls=DEFAULT_CLIENT_SERVICE_URLS, user_agent=DEFAULT_USER_AGENT,
                 ...
                 proxies: typing.Dict[str, httpcore._async.interfaces.AsyncRequestInterface] = None,
